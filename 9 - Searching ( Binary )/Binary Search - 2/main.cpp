...
// duplicate element pr work nhi krega 
...
int searchInRotatedSortedArray(vector<int>arr, int target)
{
    ...
    // if jo pivot value aai hai agr target usse chota or arr[0] se bda hai , to search on left 
...
int sqrt(int n)
{
    ...
    while(s<=e)
    {
        ...
        {
            // value ko store krana jarrori hai , 
            // let's suppose or process krne pr koi new value nhi mili to 
            ans = mid;
            s = mid+1;
        }
        else
